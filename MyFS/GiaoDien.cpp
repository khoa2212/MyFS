...
void GUI::printProgress(string content, double percentage) {
    ...
    setColor(13, 0);
    cout << content; 
    gotoXY(10 - (unsigned int)content.length(), FindY());
...
{
    gotoXY((unsigned int)(right - left - text.length()) / 2, FindY());
    cout << text;
}
